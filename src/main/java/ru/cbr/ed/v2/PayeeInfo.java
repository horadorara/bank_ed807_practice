    ...
    implements Serializable
{
    ...
    protected List<PayeeAccInfo> payeeAccInfos;
    ...
    /**
     * Gets the value of the payeeAccInfos property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the payeeAccInfos property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPayeeAccInfos().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<PayeeAccInfo> getPayeeAccInfos() {
        if (payeeAccInfos == null) {
            payeeAccInfos = new ArrayList<PayeeAccInfo>();
        }
        return this.payeeAccInfos;
    }
