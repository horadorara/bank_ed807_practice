    ...
    implements Serializable
{
    ...
    protected List<AccModifList> accModifLists;
    @XmlElement(name = "AccBrfModifList")
    protected List<AccBrfModifList> accBrfModifLists;
    ...
    /**
     * Gets the value of the accModifLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the accModifLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccModifLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AccModifList> getAccModifLists() {
        if (accModifLists == null) {
            accModifLists = new ArrayList<AccModifList>();
        }
        return this.accModifLists;
    }

    /**
     * Gets the value of the accBrfModifLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the accBrfModifLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccBrfModifLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AccBrfModifList> getAccBrfModifLists() {
        if (accBrfModifLists == null) {
            accBrfModifLists = new ArrayList<AccBrfModifList>();
        }
        return this.accBrfModifLists;
    }
