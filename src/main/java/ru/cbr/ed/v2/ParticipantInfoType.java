    ...
    implements Serializable
{
    ...
    protected List<RstrListType> rstrLists;
    ...
    /**
     * Gets the value of the rstrLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the rstrLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getRstrLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<RstrListType> getRstrLists() {
        if (rstrLists == null) {
            rstrLists = new ArrayList<RstrListType>();
        }
        return this.rstrLists;
    }
