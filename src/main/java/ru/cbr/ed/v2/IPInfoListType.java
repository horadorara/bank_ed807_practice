    ...
    implements Serializable
{
    ...
    protected List<IPBICAccListType> ipbicAccLists;

    /**
     * Gets the value of the ipbicAccLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the ipbicAccLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getIPBICAccLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<IPBICAccListType> getIPBICAccLists() {
        if (ipbicAccLists == null) {
            ipbicAccLists = new ArrayList<IPBICAccListType>();
        }
        return this.ipbicAccLists;
    }
