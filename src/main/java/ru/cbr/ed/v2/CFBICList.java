    ...
    implements Serializable
{
    ...
    protected List<String> cfbics;

    /**
     * Gets the value of the cfbics property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the cfbics property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getCFBICS().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<String> getCFBICS() {
        if (cfbics == null) {
            cfbics = new ArrayList<String>();
        }
        return this.cfbics;
    }
