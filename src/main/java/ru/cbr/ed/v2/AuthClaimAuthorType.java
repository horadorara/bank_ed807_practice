    ...
    implements Serializable
{
    ...
    protected List<BICAccCSListType> accountsLists;

    /**
     * Gets the value of the accountsLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the accountsLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccountsLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<BICAccCSListType> getAccountsLists() {
        if (accountsLists == null) {
            accountsLists = new ArrayList<BICAccCSListType>();
        }
        return this.accountsLists;
    }
