    ...
    implements Serializable
{
    ...
    protected List<AccRstrListType> accRstrLists;
    ...
    /**
     * Gets the value of the accRstrLists property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the Jakarta XML Binding object.
     * This is why there is not a <CODE>set</CODE> method for the accRstrLists property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAccRstrLists().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<AccRstrListType> getAccRstrLists() {
        if (accRstrLists == null) {
            accRstrLists = new ArrayList<AccRstrListType>();
        }
        return this.accRstrLists;
    }
